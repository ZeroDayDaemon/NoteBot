...
@Mod(modid = NoteBot.MODID, version = NoteBot.VERSION)
public class NoteBot
{
    public static final String MODID = "notebot";
    ...
    public void OnHUD(RenderGameOverlayEvent e)
    {
        ...
        EntityPlayerSP ply = mc.thePlayer;
        ...
        if(Player.Playing)
        {
            ...
            int playingstrwidth = mc.fontRendererObj.getStringWidth(playingstr);

            mc.fontRendererObj.drawString(playingstr, scrw / 2 - playingstrwidth / 2, 10, 0xFFFFFFFF);
            mc.fontRendererObj.drawString(lastnote, scrw / 2, 20, lastnotecolor.getRGB() | 0xFF000000);
            ...
            int startwidth = mc.fontRendererObj.getStringWidth("00:00");

            mc.fontRendererObj.drawString("00:00", scrw/2-200-startwidth-5, 31, 0xFFFFFFFF);
            mc.fontRendererObj.drawString(endstr, scrw/2+200+5, 31, 0xFFFFFFFF);
            ...
            int currentstrwidth = mc.fontRendererObj.getStringWidth(currentstr);

            mc.fontRendererObj.drawString(currentstr, scrw/2-currentstrwidth/2, 50, 0xFFFFFFFF);
        }
    ...
    public void OnRender(RenderWorldLastEvent e)
    {
        ...
        double x = ply.lastTickPosX + (ply.posX - ply.lastTickPosX) * e.partialTicks;
        double y = ply.lastTickPosY + (ply.posY - ply.lastTickPosY) * e.partialTicks;
        double z = ply.lastTickPosZ + (ply.posZ - ply.lastTickPosZ) * e.partialTicks;
