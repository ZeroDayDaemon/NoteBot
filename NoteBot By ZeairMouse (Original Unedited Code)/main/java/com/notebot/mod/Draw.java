...
public class Draw
{
    ...
    public static void Text(double x, double y, double z, String text, Vector3d plypos, Color color)
    {
      ...
      //  GL11.glDisable(GL11.GL_TEXTURE_2D);
        ...
        Minecraft.getMinecraft().fontRendererObj.drawString(text, -Minecraft.getMinecraft().fontRendererObj.getStringWidth(text) / 2, -Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT / 2, color.getRGB());
