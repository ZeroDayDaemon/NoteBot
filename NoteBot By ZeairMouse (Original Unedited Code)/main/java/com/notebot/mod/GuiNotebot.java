...
public class GuiNotebot extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(Category == 1)
        {
            int offset = fontRendererObj.FONT_HEIGHT/2+2;

            drawString(fontRendererObj, "Piano", MenuX, MenuY + offset, 0xFFFFFFFF);
            drawHorizontalLine(MenuX, MenuX + MenuWidth + 10, MenuY + 20 + 1, 0xFFFFFFFF);

            drawString(fontRendererObj, "Bass Guitar", MenuX, MenuY + 22 + offset, 0xFFFFFFFF);
            drawHorizontalLine(MenuX, MenuX + MenuWidth + 10, MenuY + 23 + 20 + 1, 0xFFFFFFFF);

            drawString(fontRendererObj, "Snare Drum", MenuX, MenuY + 44 + offset, 0xFFFFFFFF);
            drawHorizontalLine(MenuX, MenuX + MenuWidth + 10, MenuY + 46 + 20 + 1, 0xFFFFFFFF);

            drawString(fontRendererObj, "Sticks", MenuX, MenuY + 66 + offset, 0xFFFFFFFF);
            drawHorizontalLine(MenuX, MenuX + MenuWidth + 10, MenuY + 69 + 20 + 1, 0xFFFFFFFF);

            drawString(fontRendererObj, "Bass Drum", MenuX, MenuY + 88 + offset, 0xFFFFFFFF);
        ...
        else if(Category == 2)
        {
            ...
            if(AlreadyConverted)
                drawString(fontRendererObj, "Already converted", MenuX + MenuWidth / 2 + 54, MenuY + MenuHeight + 10, 0xFFFFFF00);
            else
            {
                if (!HasConverted)
                    drawString(fontRendererObj, "Waiting to convert", MenuX + MenuWidth / 2 + 54, MenuY + MenuHeight + 10, 0xFFFFFFFF);
                else
                    drawString(fontRendererObj, "Converted", MenuX + MenuWidth / 2 + 54, MenuY + MenuHeight + 10, 0xFFAAFFAA);
            }
        }
        else if(Category == 3)
        {
            ...
            if(ChosenFile == null)
                drawString(fontRendererObj, "No file chosen", MenuX-26+100+4, MenuY-20, 0xFFFFFFFF);
            else
                drawString(fontRendererObj, ChosenFile.getName(), MenuX-26+100+4, MenuY-20, 0xFFFFFFFF);
        }
        else if(Category == 4)
        {
        ...
        else if(Category == 6)
        {
            ...
            discoverspeed.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
            tunespeed.drawButtonForegroundLayer(mouseX, mouseY);
            tunespeed.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
        }
    ...
    public void actionPerformed(GuiButton button)
    {
        ...
        case 301:
            ...
            Minecraft.getMinecraft().getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation(res)));
            break;
